...
const slides = [
  {
    ...
    description:
      "High-quality pharmaceutical printing output with precise color and sharp finish.",
    cta: "Order Now",
  ...
  },
  {
    ...
    subtitle: "Kanha Graphics",
    description:
      "Reliable pharmaceutical packaging and print quality suitable for production use.",
  ...
  },
  {
    ...
    subtitle: "Kanha Graphics",
    description:
      "Consistent quality and premium finish designed for medicine and packaging needs.",
    cta: "Order Now",
    href: "/order?service=carton-printing",
  ...
  },
  {
    ...
    subtitle: "Kanha Graphics",
    description:
      "Clean and attractive print finish with strong visual quality for product branding.",
    cta: "Get Instant Quote",
    href: "/order?service=blister-strips-sachet",
  ...
  },
  {
    ...
    subtitle: "Kanha Graphics",
    description:
      "Vibrant, durable and production-ready product printing tailored to your requirements.",
    cta: "Order Now",
    href: "/order?service=carton-printing",
  ...
  },
  {
    ...
    subtitle: "Kanha Graphics",
    description:
      "Trusted print results for pharmaceutical products with detail-focused finishing.",
    cta: "Get Instant Quote",
    href: "/order?service=blister-strips-sachet",
